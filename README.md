...
```
Demo:
![demo](https://raw.githubusercontent.com/Beyarz/portforge.cr/master/demo.png){:height="24px" width="80px"}
![result](https://raw.githubusercontent.com/Beyarz/portforge.cr/master/result.png){:height="24px" width="80px"}
